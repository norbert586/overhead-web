...
const COUNTRY_META: Record<string, { iso: string; name: string }> = {
  ...
  // ── New entries ──────────────────────────────────────────────────────────────
  country_zwe:   { iso: 'ZW', name: 'Zimbabwe' },
  country_fra_b: { iso: 'FR', name: 'France' },
  country_deu_b: { iso: 'DE', name: 'Germany' },
  country_rus_b: { iso: 'RU', name: 'Russia' },
  country_gbr_b: { iso: 'GB', name: 'United Kingdom' },
  country_usa_b: { iso: 'US', name: 'United States' },
  country_zaf_b: { iso: 'ZA', name: 'South Africa' },
  country_jpn_b: { iso: 'JP', name: 'Japan' },
  country_egy_b: { iso: 'EG', name: 'Egypt' },
  country_chn_b: { iso: 'CN', name: 'China' },
  country_isr:   { iso: 'IL', name: 'Israel' },
  country_mex:   { iso: 'MX', name: 'Mexico' },
  country_lby:   { iso: 'LY', name: 'Libya' },
  country_vnm:   { iso: 'VN', name: 'Vietnam' },
  country_bra_b: { iso: 'BR', name: 'Brazil' },
  country_irn:   { iso: 'IR', name: 'Iran' },
  country_aus_b: { iso: 'AU', name: 'Australia' },
  country_ita_b: { iso: 'IT', name: 'Italy' },
  country_ind_b: { iso: 'IN', name: 'India' },
  country_prk:   { iso: 'KP', name: 'North Korea' },
  country_arg_b: { iso: 'AR', name: 'Argentina' },
  country_tur_b: { iso: 'TR', name: 'Turkey' },
  country_pol_b: { iso: 'PL', name: 'Poland' },
  country_sau_b: { iso: 'SA', name: 'Saudi Arabia' },
  country_col:   { iso: 'CO', name: 'Colombia' },
  country_grc_b: { iso: 'GR', name: 'Greece' },
  country_nga_b: { iso: 'NG', name: 'Nigeria' },
  country_cub:   { iso: 'CU', name: 'Cuba' },
  country_afg:   { iso: 'AF', name: 'Afghanistan' },
  country_eth_b: { iso: 'ET', name: 'Ethiopia' },
  country_esp_b: { iso: 'ES', name: 'Spain' },
  country_can:   { iso: 'CA', name: 'Canada' },
  country_swe_b: { iso: 'SE', name: 'Sweden' },
  country_nor_b: { iso: 'NO', name: 'Norway' },
  country_fin:   { iso: 'FI', name: 'Finland' },
  country_ukr_b: { iso: 'UA', name: 'Ukraine' },
  country_pak:   { iso: 'PK', name: 'Pakistan' },
  country_idn_b: { iso: 'ID', name: 'Indonesia' },
  country_phl:   { iso: 'PH', name: 'Philippines' },
  country_tha_b: { iso: 'TH', name: 'Thailand' },
  country_mys:   { iso: 'MY', name: 'Malaysia' },
  country_kor_b: { iso: 'KR', name: 'South Korea' },
  country_irq:   { iso: 'IQ', name: 'Iraq' },
  country_syr:   { iso: 'SY', name: 'Syria' },
  country_jor:   { iso: 'JO', name: 'Jordan' },
  country_mar_b: { iso: 'MA', name: 'Morocco' },
  country_dza:   { iso: 'DZ', name: 'Algeria' },
  country_ago:   { iso: 'AO', name: 'Angola' },
  country_ken_b: { iso: 'KE', name: 'Kenya' },
  country_tza:   { iso: 'TZ', name: 'Tanzania' },
  country_cod:   { iso: 'CD', name: 'DR Congo' },
  country_per:   { iso: 'PE', name: 'Peru' },
  country_chl_b: { iso: 'CL', name: 'Chile' },
  country_ven:   { iso: 'VE', name: 'Venezuela' },
  country_bol:   { iso: 'BO', name: 'Bolivia' },
  country_prt_b: { iso: 'PT', name: 'Portugal' },
  country_nld_b: { iso: 'NL', name: 'Netherlands' },
  country_bel:   { iso: 'BE', name: 'Belgium' },
  country_che_b: { iso: 'CH', name: 'Switzerland' },
  country_aut:   { iso: 'AT', name: 'Austria' },
  country_hun:   { iso: 'HU', name: 'Hungary' },
  country_rou:   { iso: 'RO', name: 'Romania' },
  country_bgr:   { iso: 'BG', name: 'Bulgaria' },
  country_srb:   { iso: 'RS', name: 'Serbia' },
  country_irl_b: { iso: 'IE', name: 'Ireland' },
  country_nzl_b: { iso: 'NZ', name: 'New Zealand' },
  country_sgp_b: { iso: 'SG', name: 'Singapore' },
  country_bgd:   { iso: 'BD', name: 'Bangladesh' },
  country_lka:   { iso: 'LK', name: 'Sri Lanka' },
  country_mng:   { iso: 'MN', name: 'Mongolia' },
  country_kaz:   { iso: 'KZ', name: 'Kazakhstan' },
  country_uzb:   { iso: 'UZ', name: 'Uzbekistan' },
  country_sdn:   { iso: 'SD', name: 'Sudan' },
  country_som:   { iso: 'SO', name: 'Somalia' },
  country_yem:   { iso: 'YE', name: 'Yemen' },
  country_omn:   { iso: 'OM', name: 'Oman' },
  country_qat_b: { iso: 'QA', name: 'Qatar' },
  country_kwt:   { iso: 'KW', name: 'Kuwait' },
  country_lbn:   { iso: 'LB', name: 'Lebanon' },
  country_tun:   { iso: 'TN', name: 'Tunisia' },
  country_gha:   { iso: 'GH', name: 'Ghana' },
  country_sen:   { iso: 'SN', name: 'Senegal' },
  country_civ:   { iso: 'CI', name: 'Ivory Coast' },
  country_cmr:   { iso: 'CM', name: 'Cameroon' },
  country_zmb:   { iso: 'ZM', name: 'Zambia' },
  country_bwa:   { iso: 'BW', name: 'Botswana' },
  country_nam:   { iso: 'NA', name: 'Namibia' },
  country_moz:   { iso: 'MZ', name: 'Mozambique' },
  country_mdg:   { iso: 'MG', name: 'Madagascar' },
  country_isl:   { iso: 'IS', name: 'Iceland' },
  country_dnk:   { iso: 'DK', name: 'Denmark' },
  country_est:   { iso: 'EE', name: 'Estonia' },
  country_lva:   { iso: 'LV', name: 'Latvia' },
  country_ltu:   { iso: 'LT', name: 'Lithuania' },
  country_blr:   { iso: 'BY', name: 'Belarus' },
  country_mda:   { iso: 'MD', name: 'Moldova' },
  country_geo:   { iso: 'GE', name: 'Georgia' },
  country_arm:   { iso: 'AM', name: 'Armenia' },
  country_aze:   { iso: 'AZ', name: 'Azerbaijan' },
};
